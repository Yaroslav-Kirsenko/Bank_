...
public class Client {
    ...
    public Client(String fName, String lName, String pAddress, Account cAccount, Account sAccount, LocalDate date){
        ...
        this.payeeAddress = new SimpleStringProperty(this, "pAddress", pAddress);
        this.checkingAccount = new SimpleObjectProperty<Account>(this, "chAccount", cAccount);
        this.savingsAccount = new SimpleObjectProperty<Account>(this, "svAccount", sAccount);
        this.dateCreated = new SimpleObjectProperty<LocalDate>(this, "Data", date);
    }
